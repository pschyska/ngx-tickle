...
[![docs.rs](https://img.shields.io/docsrs/ngx-tickle/0.2.0)](https://docs.rs/ngx-tickle/0.2.0/ngx_tickle/)
...
[`spawn()`]: https://docs.rs/ngx-tickle/0.2.0/ngx_tickle/fn.spawn.html
[`async_task`]: https://docs.rs/async-task/latest/async_task/
[`set_max_runnables_per_wakeup()`]: https://docs.rs/ngx-tickle/0.2.0/ngx_tickle/fn.set_max_runnables_per_wakeup.html
